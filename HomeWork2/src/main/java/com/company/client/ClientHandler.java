...
import com.company.ServerLogger;
...
public class ClientHandler {
            ...
            executor.execute(
                    new Thread(() ->{
                        try {
                            ...
                            logic.connectionClosed(nickname);
                            System.out.println("Соеденинение с клиентом " + nickname + " было закрыто!");
                        } finally {
                            timeOutThread.interrupt();
                            closeConnection();
        ...
        while (true){
            ...
            switch (command.getType()){
                ...
                case PRIVATE_MESSAGE: {
                    ...
                    logic.clientSendMessage(nickname);
                    break;
                }
                ...
                case UPDATE_USER_NICKNAME:
                    ...
                    logic.tryUpdateUserName(oldNickname, newNickName);
                    networkServer.updateUsersNicknames(oldNickname, newNickName);
                    break;
                default:
                    System.err.println("Unknown type of command : " + command.getType());
                    logic.receivedUnknownCommand(command.getType());
                    break;
            }
        }
    }
    ...
    private Command readCommand() throws IOException {
        try {
            ...
            logic.receivedUnknownObjectFromClient();
            e.printStackTrace();
    ...
    private void authentication() throws IOException {
        ...
        while (true){
            ...
            if (command.getType() == CommandType.AUTH) {
                ...
                logic.unknownCommandForAuthProcess(command.getType());
            }
        }
    }
