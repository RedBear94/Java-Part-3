...
// Позволяет отправлять команды в виде объектов
public class Command implements Serializable {
    // Serializable - пометка того, что объекты сериализуемы - можно конвертивать
    // с использованием ObjectInputStream/ObjectOutputStream в байты данных, передаваемых по сети
